...
describe('Transferencias', () => {
    ...
    describe('GET /transferencias/{id}', () => {
        it('Deve retornar sucesso com 200 e dados iguais ao registro do banco de dados quando o registro for válido', async () => {
            const resposta = await request(process.env.BASE_URL)
    ...
    describe('GET /transferencias', () => {
        it('Deve retronar 10 elementos na paginação quando informar limite de 10 registros', async () => {
            const resposta = await request(process.env.BASE_URL)
